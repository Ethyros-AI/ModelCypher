...
def main() -> None:
    ...
    saturation_summary = {
        ...
        "mean_null_rank": sum(capacity_report.layer_metrics.values()) / max(1, len(capacity_report.layer_metrics)) if capacity_report.layer_metrics else 0.0,
        "layers": capacity_report.layer_metrics
    }
