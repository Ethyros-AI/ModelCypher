...
def test_geometric_alignment_sentinel():
    print("Testing GeometricAlignmentSystem Sentinel...")
    ...
    print("✅ GAS Sentinel verified.")

def test_geometric_alignment_director():
    print("Testing GeometricAlignmentSystem Director...")
    config = GASConfig.default()
    ...
    print(f"  Final Level: {decision.level}")
    print("✅ GAS Director verified.")

def test_circuit_breaker_integration():
    print("Testing CircuitBreakerIntegration...")
    ...
    print("✅ CircuitBreakerIntegration verified.")

if __name__ == "__main__":
    test_geometric_alignment_sentinel()
    test_geometric_alignment_director()
