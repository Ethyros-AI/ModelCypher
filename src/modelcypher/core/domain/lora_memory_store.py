...
class LoRAMemoryStore:
    ...
    def derive_learning_rate(self) -> float:
        """Derive base learning rate from spectral geometry (η = 1/σ_max).

        Uses optimizer geometry config derived from SVD of event weight views.
        Falls back to √ε_f32 when no weight views are available.
        """
