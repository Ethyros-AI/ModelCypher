...
def spectral_normalized_init(
    ...
    For LoRA matrices: Initialize so ||B @ A||_spectral = σ_k
    (uses full geometric budget from step 0).

    Mathematical guarantee: σ_max(output) = target_spectral ± O(√ε)
...
# =============================================================================
# Array Validation (moved from _primitives/validation.py)
# =============================================================================
...
# =============================================================================
# Convergence Monitoring (moved from _primitives/convergence.py)
# =============================================================================
