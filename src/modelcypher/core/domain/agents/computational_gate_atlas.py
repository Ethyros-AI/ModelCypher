...
class ComputationalGateInventory:
    ...
    def core_gates() -> list[ComputationalGate]:
        return [
            ...
            ComputationalGate(
                "1",
                1,
                ComputationalGateCategory.CORE_CONCEPTS,
                "LITERAL",
            ...
            ComputationalGate(
                "2",
                2,
                ComputationalGateCategory.CONTROL_FLOW,
                "CONDITIONAL",
            ...
            ComputationalGate(
                "3",
                3,
                ComputationalGateCategory.FUNCTIONS_SCOPING,
                "INVOKE",
            ...
            ComputationalGate(
                "7",
                7,
                ComputationalGateCategory.DATA_TYPES,
                "ARRAY",
            ...
            ComputationalGate(
                "14",
                14,
                ComputationalGateCategory.DOMAIN_SPECIFIC,
                "MATCH",
            ...
            ComputationalGate(
                "15",
                15,
                ComputationalGateCategory.CONCURRENCY_PARALLELISM,
                "ASYNC",
            ...
            ComputationalGate(
                "39",
                39,
                ComputationalGateCategory.MEMORY_MANAGEMENT,
                "ALLOCATION",
            ...
            ComputationalGate(
                "23",
                23,
                ComputationalGateCategory.SYSTEM_IO,
                "INPUT",
            ...
            ComputationalGate(
                "22",
                22,
                ComputationalGateCategory.MODULARITY,
                "MODULE",
            ...
            ComputationalGate(
                "12",
                12,
                ComputationalGateCategory.ERROR_HANDLING,
                "ERROR",
            ...
            ComputationalGate(
                "13",
                13,
                ComputationalGateCategory.OBJECT_ORIENTED,
                "CLASS",
            ...
            ComputationalGate(
                "11",
                11,
                ComputationalGateCategory.METAPROGRAMMING,
                "MACRO",
            ...
            ComputationalGate(
                "54",
                54,
                ComputationalGateCategory.UNCATEGORIZED,
                "UNKNOWN",
    ...
    def composite_gates() -> list[ComputationalGate]:
        return [
            ComputationalGate(
                "67",
                67,
                ComputationalGateCategory.COMPOSITE,
                "LOCK_GATE",
    ...
    def all_gates() -> list[ComputationalGate]:
        return (
            ComputationalGateInventory.core_gates() + ComputationalGateInventory.composite_gates()
        )
    ...
    def _parse_entries(cls, entries: list[dict]) -> list[ComputationalGate]:
        ...
        for item in entries:
            ...
            category = ComputationalGateCategory.__members__.get(
                category_key, ComputationalGateCategory.uncategorized
            )
...
class ComputationalGateAtlas:
    ...
    def generate_probe_prompts(
        style: PromptStyle = PromptStyle.COMPLETION, subset_name: str = "probe"
        ...
        for gate in gates:
            ...
            if style == ComputationalGateAtlas.PromptStyle.COMPLETION:
                ...
                if ex:
                    prompt = (
                        f"Here is an example of {gate.name} in code:\n{ex}\n\nThis demonstrates"
                    )
                else:
