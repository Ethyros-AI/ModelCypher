...
class GeometryTrainingService:
    ...
    def training_status_payload(self, job_id: str, output_format: str = "full") -> dict:
        ...
        return {
            ...
            "flatnessAssessment": metrics.flatness_assessment if output_format == "full" else None,
            ...
            "snrAssessment": metrics.snr_assessment if output_format == "full" else None,
    ...
    def training_history_payload(self, job_id: str) -> dict:
        ...
        return {
            ...
            "interpretation": interpretation,
            "nextActions": [
                "tc_geometry_training_status for current metrics",
                "tc_job_detail for full job information",
            ],
        }
