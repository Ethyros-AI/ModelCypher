...
class GeometryPersonaService:
    ...
    def cluster_points(
        ...
        manifold_points = [
            ManifoldPoint(
                ...
                mean_gate_similarity=p.get("mean_gate_similarity", 0.0),
    ...
    def query_region(
        ...
        manifold_point = ManifoldPoint(
            ...
            mean_gate_similarity=point.get("mean_gate_similarity", 0.0),
        ...
        for r in regions:
            ...
            centroid = ManifoldPoint(
                ...
                mean_gate_similarity=centroid_data.get("mean_gate_similarity", 0.0),
