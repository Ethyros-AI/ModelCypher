...
class SettingsService:
    ENV_IDLE_TRAINING_ENABLED = "TC_IDLE_TRAINING_ENABLED"
    ENV_IDLE_TRAINING_MIN_IDLE_SECONDS = "TC_IDLE_TRAINING_MIN_IDLE_SECONDS"
    ENV_IDLE_TRAINING_MAX_THERMAL_STATE = "TC_IDLE_TRAINING_MAX_THERMAL_STATE"
    ENV_MAX_MEMORY_USAGE_PERCENT = "TC_MAX_MEMORY_USAGE_PERCENT"
    ENV_AUTO_SAVE_CHECKPOINTS = "TC_AUTO_SAVE_CHECKPOINTS"
    ENV_PLATFORM_LOGGING_OPT_IN = "TC_PLATFORM_LOGGING_OPT_IN"
