...
@entropy_app.command("detect-distress")
...
@entropy_app.command("verify-baseline")
...
@geometry_metrics_app.command("gromov-wasserstein")
...
@geometry_metrics_app.command("intrinsic-dimension")
def geometry_metrics_intrinsic_dimension(
    ctx: typer.Context,
    points_file: str = typer.Argument(..., help="Path to point cloud (JSON array of arrays)"),
    use_regression: bool = typer.Option(True, "--use-regression/--use-ml", help="Use regression method vs maximum likelihood"),
...
@geometry_metrics_app.command("topological-fingerprint")
