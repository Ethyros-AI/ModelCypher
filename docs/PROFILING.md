...
```bash
# Use only semantic primes (65 probes instead of 465)
...
**Cause:** 465 probes × N layers × batch inference
...
|-----------|------|-------|
| Model probe (0.5B) | ~5s | Full 465 probes |
| Model probe (7B) | ~30s | Full 465 probes |
