...
```bash
# Use only semantic primes (65 probes instead of 439)
...
**Cause:** 439 probes × N layers × batch inference
...
|-----------|------|-------|
| Model probe (0.5B) | ~5s | Full 439 probes |
| Model probe (7B) | ~30s | Full 439 probes |
