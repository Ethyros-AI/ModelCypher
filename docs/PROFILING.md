...
```bash
# Use only semantic primes (65 probes instead of 441)
...
**Cause:** 441 probes × N layers × batch inference
...
|-----------|------|-------|
| Model probe (0.5B) | ~5s | Full 441 probes |
| Model probe (7B) | ~30s | Full 441 probes |
