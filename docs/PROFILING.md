...
```bash
# Use only semantic primes (65 probes instead of 402)
...
**Cause:** 402 probes × N layers × batch inference
...
|-----------|------|-------|
| Model probe (0.5B) | ~5s | Full 402 probes |
| Model probe (7B) | ~30s | Full 402 probes |
